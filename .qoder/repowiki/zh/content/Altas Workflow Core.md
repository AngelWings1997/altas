...
## 更新摘要
**变更内容**
- 新增统一触发词字典系统，创建集中式触发词管理机制
- 触发词系统扩展至 20+ 个关键词，包含中英文别名
- 路由系统重构，支持 12 种工作流模式
...
- [SKILL.md:80-103](file://altas-workflow/SKILL.md#L80-L103)
- [SKILL-entry-review.md:19-22](file://altas-workflow/SKILL-entry-review.md#L19-L22)
...
Altas Workflow 4.1 版本引入了全新的统一触发词字典系统，实现了以下改进：
