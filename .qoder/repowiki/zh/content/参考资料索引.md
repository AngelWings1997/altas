...
**图表来源**
- [reference-index.md:1-251](file://altas-workflow/reference-index.md#L1-L251)
...
- [reference-index.md:83-147](file://altas-workflow/reference-index.md#L83-L147)
...
## 结论
通过"阶段索引 + 模式索引 + 来源索引 + 规模索引"的四维索引体系，结合 SKILL.md 的渐进披露与 QUICKSTART.md 的触发词，用户可以在不同复杂度的任务中快速定位所需参考，实现"按需加载、检查点推进、铁律约束"的高效开发流程。新增的五种特殊模式进一步完善了 ALTAS Workflow 的专业能力矩阵，覆盖了从基础开发到专业优化的完整生命周期。
