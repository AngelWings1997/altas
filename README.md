...
**仓库规模:** 8.3M, 169 个 Markdown 文件, 79 个参考资料
...
```
altas/
├── altas-workflow/              # 主协议目录 (8.3M, 92 个文件)
...
| **参考资料** | 79 个 | Spec 驱动 (7) / Checkpoint (4) / Superpowers (37) / Agents (22) / Entry (4) / Special-Modes (5) |
...
Markdown 文件：169 个
参考资料：79 个
  - Spec-Driven Development: 7 个
  - Checkpoint-Driven: 4 个
  - Superpowers: 37 个
  - Agents: 22 个
  - Entry: 4 个
  - Special-Modes: 5 个
