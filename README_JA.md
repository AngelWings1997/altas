...
**バージョン:** 4.0 (2026-04-14)  
**リポジトリサイズ:** 2.2M, 86 Markdownファイル, 70参照ドキュメント
...
```
altas/
├── altas-workflow/              # メインプロトコルディレクトリ (2.2M, 86ファイル)
...
| **参照資料** | 70 | Spec駆動 (7) / Checkpoint (4) / Superpowers (37) / Agents (22) |
