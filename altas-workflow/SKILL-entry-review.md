...
| # | 建议 | 说明 | 优先级 |
|---|------|----------|--------|
| 1 | 统一 code-review 目录结构 | `go-code-review/` vs `python-code-review/` vs `code-reviewer.md` | 低 |
| 2 | Agent 专用文件重复问题 | `agents/sdd-riper-one/references/` 与 `spec-driven-development/` 内容高度重复 | 低 |
| 3 | 重命名 checkpoint-driven/SKILL.md | 实际内容是 sdd-riper-one-light | 低 |
