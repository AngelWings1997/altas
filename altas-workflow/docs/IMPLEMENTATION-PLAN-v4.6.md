...
[references/superpowers/test-driven-development/SKILL.md](file:///Users/litianyi/trae/altas/altas-workflow/references/superpowers/test-driven-development/SKILL.md#L37-L46) 要求"写了实现代码的先删掉从头来"，但 [SDD-RIPER-ONE](file:///Users/litianyi/trae/altas/altas-workflow/references/spec-driven-development/sdd-riper-one-protocol.md#L134-L157) 在 PLAN 阶段已定义了精确的签名和实现细节。当 Plan 已经足够精确时，TDD 的"删掉重写"变成多余的仪式。

### 改动

#### 1.1 SKILL.md → EXECUTE 章节

**当前** ([SKILL.md:393-398](file:///Users/litianyi/trae/altas/altas-workflow/SKILL.md#L393-L398)):
```markdown
### EXECUTE
...
在 [references/superpowers/test-driven-development/SKILL.md](file:///Users/litianyi/trae/altas/altas-workflow/references/superpowers/test-driven-development/SKILL.md#L351) 的 "Debugging Integration" 章节之前，插入新章节：
...
当前 [spec-template.md](file:///Users/litianyi/trae/altas/altas-workflow/references/spec-driven-development/spec-template.md#L62-L84) 的 `§4. Plan` 只有 File Changes、Signatures、Checklist、Spec Review Notes，没有专门的测试策略声明。Agent 在 TDD 执行时需要自行决定测试范围、框架和优先级。
...
在 [SKILL.md:381-391](file:///Users/litianyi/trae/altas/altas-workflow/SKILL.md#L381-L391) 的 PLAN 章节末尾增加一行：
...
当前 [SKILL.md](file:///Users/litianyi/trae/altas/altas-workflow/SKILL.md#L320-L359) 的检查点契约依赖 Agent 的"自觉"输出，缺少对模型行为的强制约束。QUICKSTART.md 第 677 行承认用户需要手动说"请停止，严格执行检查点机制"来纠正 Agent 暴走。

### 改动

#### 3.1 SKILL.md → 在检查点契约后增加硬约束

在 [SKILL.md:359](file:///Users/litianyi/trae/altas/altas-workflow/SKILL.md#L359) 的完整检查点模板之后，新增：
...
在 [sdd-riper-one-protocol.md:199-207](file:///Users/litianyi/trae/altas/altas-workflow/references/spec-driven-development/sdd-riper-one-protocol.md#L199-L207) 的 Batch Override 规则中，在 "Emergency Stop" 后增加：
...
当前规模评估在首轮响应时完成（[SKILL.md:188-204](file:///Users/litianyi/trae/altas/altas-workflow/SKILL.md#L188-L204)），但 Agent 在 Research 阶段获得更多信息后，可能发现实际复杂度与初始评估不符，缺少正式的"再评估"机制。

### 改动

#### 4.1 SKILL.md → 在规模评估章节新增 "Research 后重估"

在 [SKILL.md:204](file:///Users/litianyi/trae/altas/altas-workflow/SKILL.md#L204) 的 "升降级" 节后新增：
...
[SDD-RIPER-DUAL-COOP.md](file:///Users/litianyi/trae/altas/altas-workflow/protocols/SDD-RIPER-DUAL-COOP.md) 和 [sdd-riper-one-protocol.md](file:///Users/litianyi/trae/altas/altas-workflow/references/spec-driven-development/sdd-riper-one-protocol.md#L389-L497) 定义了多项目模式，但当 Internal Model（Scout）发现的代码事实与 External Model（Architect）的 Spec 假设矛盾时，没有明确的仲裁流程。

### 改动

#### 5.1 sdd-riper-one-protocol.md → 在 MULTI 协议末尾新增 §8

在 [sdd-riper-one-protocol.md:527](file:///Users/litianyi/trae/altas/altas-workflow/references/spec-driven-development/sdd-riper-one-protocol.md#L527) 的 "Guarantee" 节后新增：
...
[SKILL-entry-review.md](file:///Users/litianyi/trae/altas/altas-workflow/SKILL-entry-review.md#L396-L414) 记录了 17 项低优先级问题，其中 G（渐进式导航）和 X（The Bottom Line 总结）投入产出比最高。

### 改动

#### 6.1 SKILL.md → 新增 Quick Navigation 章节（关闭 G）

在 [SKILL.md:37](file:///Users/litianyi/trae/altas/altas-workflow/SKILL.md#L37) 的 Overview 章节后新增：
...
在 [sdd-riper-one-protocol.md:199-207](file:///Users/litianyi/trae/altas/altas-workflow/references/spec-driven-development/sdd-riper-one-protocol.md#L199-L207) 的 "Emergency Stop" 后增加：
